...
public class WidgetRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory  {
    ...
    public RemoteViews getViewAt(int position) {
        RemoteViews listviewWidget = new RemoteViews(context.getPackageName(), R.layout.todo_collection);
        listviewWidget.setTextViewText(R.id.todoName, arrayList.get(position).content);
        ...
        listviewWidget.setOnClickFillInIntent(R.id.todoName, dataIntent);
